...
public class MapperScannerBeanDefinitionParser implements BeanDefinitionParser {
   ...
   */
  /**
   * mybatis将自己的xml中的标签解析成BeanDefinition
   * 由spring的BeanDefinitionParserDelegate以下代码调用
   * @Nullable
   ...
   * @return
   */
  // 这里注册BD的方式参考注解实现  MapperScannerRegistrar.registerBeanDefinitions
  @Override
  public synchronized BeanDefinition parse(Element element, ParserContext parserContext) {
    // 这里可能是参考spring的源码风格，新建了一个scanner
